...
- **HTML5**__ for the static structure
- _**JavaScript**_ for dynamically modifying the pages


### Entity-Relationship Schema

<p align="center">
  <img width="80%" src="https://github.com/arigalzi/Database2-Project/blob/master/db_project1/design/LAST_ER.jpg">
</p>


Other design choices are accurately described in the Design folder.
